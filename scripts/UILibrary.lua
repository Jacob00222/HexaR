...
local library = {
    ...
    settings = {
        ...
        footer = " in development private version",
        modal = true,
    ...
    theme = {
        buttons = Color3.fromRGB(51, 0, 255), -- toggle, sliders colors
        text = Color3.fromRGB(255, 255, 255),
        textboxtext = Color3.fromRGB(118, 94, 255),
        main = Color3.fromRGB(0, 0, 0),
        outline = Color3.fromRGB(0, 47, 51),
        tabholder = Color3.fromRGB(27, 0, 107),
        tabbutton = Color3.fromRGB(14, 0, 56),
